...
import { normalizeChainKey, type ChainKey } from '../config/index.js'
 ...
 * @returns True if valid
 */
export function isValidAddress(address: string, chainKey: ChainKey): boolean {
  try {
 ...
 * @returns True if valid
 */
export function isValidMnemonic(mnemonic: string, wordCount: number = 12): boolean {
 ...
 * @returns True if valid
 */
export function isValidTransactionHash(hash: string, chainKey: ChainKey): boolean {
 ...
 * @returns True if valid
 */
export function isValidMessageLength(message: string, maxLength: number = 1600): boolean {
