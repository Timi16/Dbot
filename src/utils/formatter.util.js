 ...
 */
export function formatBalance(balance, maxDecimals = 6) {
 ...
 */
export function formatBalanceWithSymbol(balance, symbol, maxDecimals = 6) {
 ...
 */
export function formatGasFee(gasFee, symbol, valueUSD) {
 ...
 */
export function formatSlippage(slippageBps) {
