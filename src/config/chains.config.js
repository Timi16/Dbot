...
export const SUPPORTED_CHAIN_LIST = Object.keys(CHAIN_REGISTRY);
/**
 * Normalize common aliases to ChainKey
 */
export function normalizeChainKey(input) {
    ...
    if (!chainKey) {
        throw new Error(`Unsupported chain: "${input}". Supported: ${SUPPORTED_CHAIN_LIST.join(', ')}`);
    }
    return chainKey;
}
/**
 ...
 */
export function getVmType(chain) {
