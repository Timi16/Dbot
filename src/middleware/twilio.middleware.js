...
export function validateTwilioWebhook(req, res, next) {
    ...
    try {
        ...
        // Validate signature
        const isValid = validateTwilioSignature(twilioConfig.authToken, twilioSignature, url, req.body);
        if (!isValid) {
 ...
 */
export function parseTwilioWebhook(req, res, next) {
...
export function rateLimitWebhook(maxRequests = 60, windowMs = 60000 // 1 minute
) {
    return (req, res, next) => {
...
//# sourceMappingURL=twilio.middleware.js.map